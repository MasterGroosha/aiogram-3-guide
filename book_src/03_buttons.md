...
![Реакция на нажатие колбэк-кнопки](images/l03_5.png)
...
решается проблема очень просто: мы проигнорируем исключение `MessageNotModified`. Из [первой главы](01_quickstart.md#_3) вы 
