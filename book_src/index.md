...
Также у меня есть отдельная [группа в Telegram](https://telegram.dog/+DE0_2nCvbXozZjUy), где можно задать вопрос или обсудить ботов и новости вокруг них.

**Донаты**  
На написание и актуализацию книги я потратил очень много времени и сил. Если вы хотите поблагодарить 
автора (то есть меня) материально, можете сделать это через специального бота [@GrooshaDonateBot](https://telegram.dog/grooshadonatebot).   
